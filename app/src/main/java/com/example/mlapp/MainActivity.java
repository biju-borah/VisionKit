...
public class MainActivity extends AppCompatActivity {
    ...
    private void detectTxt() {
        ...
        Task<FirebaseVisionText> firebaseVisionTextTask = detector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<FirebaseVisionText>() {
            @Override
    ...
    private void calculate(){
        float Avg = 0f;
        if(txt.isEmpty()){
            Toast.makeText(MainActivity.this, "No Text in here ! ", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        calText.setText(Float.toString(Avg));
    }
}